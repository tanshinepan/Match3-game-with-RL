...
class Match3Env(gym.Env):
	...
	def load_image(self):
		...
		for i in range(self.numOfCube):
			...
			img.append(image)
		img_board=cv2.resize(cv2.imread(os.path.join(path+"99.png"),cv2.IMREAD_UNCHANGED) ,(LENGTH*2,2*LENGTH))
...
if __name__=="__main__":
	...
	a.reset()
	a.render()
	print(len(a.legal_actions))
	print((a.legal_actions))
	cv2.waitKey(0)
